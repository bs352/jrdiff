 ...
 * @author bo.shen
 */
public class RDiffSignatureGenerator {
    ...
    public RDiffSignatureGenerator(int blockLength, int strongHashLength) throws NoSuchAlgorithmException {
    ...
    public void generate(InputStream in, OutputStream out) throws IOException {
        ...
        outStream.writeInt(RDiff.SIG_MAGIC);
    ...
    private void update(byte[] buf, int offset, int len, DataOutputStream out) throws IOException {
